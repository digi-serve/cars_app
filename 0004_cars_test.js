...
var homeAdministrationVisit = (indexOfHome) => {
   cy.get(cyInterfaceCommon.button.menu).should("be.visible").click();
   cy.get(cyInterfaceCARS.navigator).should("be.visible").click();
...
describe("Test Home:", () => {
   ...
   it("Test Update existing Home", () => {
      ...
      cy.get(cyInterfaceCARS.page.socialWorker.page.home.view.homes.container)
         ...
         .should((data) => {
            expect(
               data.text().includes(home.phoneNumber) ? home.phoneNumber : "",
               "Phone Number"
