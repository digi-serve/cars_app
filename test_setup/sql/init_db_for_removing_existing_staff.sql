...
INSERT INTO `SITE_USER` (`uuid`,  `isActive`, `username`, `password`, `email`, `languageCode`) VALUES ("bb46b6b4-dc25-4915-80f7-c1febf26da4b", "1", "alice_cooper", "abf59522a9cd1c50795ffdef18c7be5d1c298867edfc2cace20d83c9b76ab2ad", "alice@cooper.com", "en");
UNLOCK TABLES;
LOCK TABLES `AB_CARS_Staff` WRITE;
INSERT INTO `AB_CARS_Staff` (`uuid`, `created_at`, `updated_at`, `translations`, `Phone`, `CARs Project512`, `Staff User`) VALUES ("e746f80b-3fbe-4aeb-9fdf-2707740eeaca", "2021-09-20 07:08:59", "2021-09-20 07:08:59", "[{\"language_code\":\"en\",\"Position\":\"Director\",\"First Name\":\"Alice\",\"Last Name\":\"Cooper\"}]", "55555555556", "cb46b6b4-dc25-4915-80f7-c1febf26da4a", "alice_cooper");
UNLOCK TABLES;
