...
INSERT INTO `AB_CARS_Notes` (`uuid`, `created_at`, `updated_at`, `Title`, `Date`, `Text`, `Child`, `Staff`) VALUES ('0969fa02-1513-4bdf-9086-8ab50ff5f986', '2021-11-15 08:38:11', '2021-11-15 08:38:11', 'New_test_label_123', '2021-11-15', '<p>New test 123123123abc</p>', '0e41a300-4698-40c8-9c5f-f96ea2ceadf6', 'e746f80b-3fbe-4aeb-9fdf-2707740eeaca');
UNLOCK TABLES;
LOCK TABLES `AB_CARS_File` WRITE;
INSERT INTO `AB_CARS_File` (`uuid`, `created_at`, `updated_at`, `translations`, `File`, `Child`, `Note`) VALUES ('16c2d1b8-4bbe-4f8d-b80e-5dc9ab61846c', '2021-11-15 08:45:21', '2021-11-15 08:45:15', '[{\"language_code\":\"en\",\"Label\":\"123.file\"}]', '{\"uuid\":null,\"filename\":\"undefined\"}', '0e41a300-4698-40c8-9c5f-f96ea2ceadf6', '20d68470-3263-4f68-a288-81f0f2097358');
UNLOCK TABLES;
...
UNLOCK TABLES;
LOCK TABLES `AB_JOINMN_Notes NotesCategories` WRITE;
INSERT INTO `AB_JOINMN_Notes_Notes Categorie_Categories` (`id`, `Notes`, `Notes Categories`) VALUES ('1', '0969fa02-1513-4bdf-9086-8ab50ff5f985', '43ab8092-5878-4cf4-a98f-6e8798ff2117');
UNLOCK TABLES;
