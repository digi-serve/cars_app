...
UNLOCK TABLES;
LOCK TABLES `AB_CARS_Staff` WRITE;
INSERT INTO `AB_CARS_Staff` (`uuid`, `created_at`, `updated_at`, `translations`, `Phone`) VALUES ("e746f80b-3fbe-4aeb-9fdf-2707740eeacb", "2021-09-20 07:08:59", "2021-09-20 07:08:59", "[{\"language_code\":\"en\",\"Position\":\"Worker\",\"First Name\":\"Alice\",\"Last Name\":\"Smith\"}]", "0899999993");
UNLOCK TABLES;
